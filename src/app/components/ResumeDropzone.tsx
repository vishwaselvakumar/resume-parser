...
export const ResumeDropzone = ({
  ...
  onSubmitBtnClick?: (resumeFile:any) => Promise<any>;
}) => {
  ...
  const handleSubmit = async()=>{
    if (onSubmitBtnClick) {
      try {
        await onSubmitBtnClick(resumeFile)
        onRemove()
      } catch (error) {
        onRemove()
      }
      ...
      >
        ...
        {!hasFile ? (
          ...
          <div className="flex items-center justify-center gap-3 pt-3">
            ...
            {/* upload to resume to database by click this button */}
            <button
              type="button"
              className="outline-theme-blue rounded-md p-1 hover:bg-gray-100 hover:text-gray-500"
              title="upload file"
