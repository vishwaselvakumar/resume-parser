...
export default function ResumeParser() {
  ...
  // function resume for upload to backend
  const handleResumeUplaodToserver = async(file:File) => {
    try {
      const formData = new FormData();
      formData.append('file', file);
      formData.append('value', JSON.stringify(resume));
          ...
          <section className="max-w-[600px] grow">
            ...
            <div className="mt-3">
              <ResumeDropzone
                ...
                onSubmitBtnClick={(resumeFile)=>handleResumeUplaodToserver(resumeFile)}
                playgroundView={true}
              />
            </div>
